  ...
  return (
    <div className="relative bg-slate-50  flex items-center overflow-hidden py-16">
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-12 relative z-10">
        ...
        <div className="left-div space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button className="px-8 py-4 bg-green-500 text-white font-bold rounded-lg hover:bg-green-700 transition duration-300 shadow-lg shadow-blue-200">
              Explore Now
            </button>
        ...
        <div className="right-div flex justify-center">
          <div className="relative w-full max-w-lg">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-xl hidden lg:block border border-gray-100 z-2">
